...
export type GameEvent =
    ...
    | (BaseGameEvent & { type: 'MISSION_OUTCOME'; round: number; teamNames: string[]; teamMembers?: { name: string; role: string; team: Team }[]; failsCount: number; succeeded: boolean; reasonings?: { name: string; reasoning: string; self_check?: string; thought?: string; situation_assessment?: string; action_strategy?: string; promptText?: string; retryLogs?: string[] }[] })
